...
//Name: samuraiOpenLeftHand.ma
//Last modified: Mon, Sep 12, 2016 07:30:28 PM
//Codeset: 1252
requires maya "2010";
...
createNode animClip -n "samuraiOpenLeftHandSource";
	setAttr ".ihi" 0;
	setAttr ".ss" 38;
	setAttr ".se" 48;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	setAttr -s 4 ".hyp";
connectAttr "samuraiOpenLeftHandSource.cl" "clipLibrary1.sc[0]";
